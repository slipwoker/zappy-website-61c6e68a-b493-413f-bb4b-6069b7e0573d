    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "תוכן לימודי מסחר מוצלח בבורסה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '61c6e68a-b493-413f-bb4b-6069b7e0573d',
                    name: data.name || '',
                    email: data.email || '',
